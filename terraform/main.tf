...
# ── Server-Side Encryption (AES-256 by default, KMS optional) ────────────────
...
# ── Ownership Controls (disables ACLs — best practice for new buckets) ───────
...
# ── Lifecycle Rules (optional cost-saving transitions) ───────────────────────
