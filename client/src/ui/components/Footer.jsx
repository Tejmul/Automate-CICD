        ...
        <div className="footer__top">
          ...
          <div className="footer__cols">
            <div className="footer__col">
              ...
              <Link to="/shop?category=beauty" className="footer__link">Beauty</Link>
              <Link to="/shop?category=fragrances" className="footer__link">Fragrances</Link>
            ...
            <div className="footer__col">
              ...
              <Link to="/wishlist" className="footer__link">Saved Items</Link>
