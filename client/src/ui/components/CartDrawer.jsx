              ...
              {lines.map((line) => (
                <div key={line.productId} className="cart-item">
                  ...
                  <div className="cart-item__info">
                    <p className="cart-item__brand label-sm">
                      {line.product?.brand || line.product?.category || "Item"}
                    </p>
                    ...
                    <div className="cart-item__controls">
                      ...
                      <button
                        ...
                        onClick={() =>
                          cartActions.remove.mutate(line.productId)
                        }
                      >
                        Remove
                      </button>
        ...
        {lines.length > 0 && (
          <div className="cart-drawer__footer">
            ...
            <div className="cart-drawer__subtotal cart-drawer__subtotal--total">
              <span>Total</span>
              <span>
                ${(Number(subtotal) + (subtotal > 99 ? 0 : 9.99)).toFixed(2)}
              </span>
            </div>
            <Link
              to="/cart"
